...
-- Run this script to set up your entire database
...
CREATE POLICY "Everyone can read competitions" ON competitions
...
-- Everyone can read users (for team posts)
